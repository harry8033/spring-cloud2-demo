app.controller('OptLogController', ['$scope', '$rootScope', '$env', '$component', 'w5cValidator',
    function ($scope, $rootScope, $env, $component, w5cValidator) {
        ...
        $scope.loadData = function () {
            $component.post($env.url + 'sys/optlog/findByPage',{
        ...
        $scope.delEntity = function (v, $event) {
            $component.confirm(Message.DEL_CONFIRM, function () {
                $component.post($env.url + 'sys/optlog/delete',
                    {ids: [v.id]},
                    function () {
        ...
        $scope.saveEntity = function () {
            $component.post($env.url + 'sys/optlog/saveEntity', $scope.entity, function(response){
                $scope.loadData();
